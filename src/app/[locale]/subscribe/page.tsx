          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-stone-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="bg-violet-50 dark:bg-slate-700 p-6 text-center">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-4xl font-bold text-neutral-800 dark:text-slate-100">{t('price')}</span>
            ...
            <div className="p-8">
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature1')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature2')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature3')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature4')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature5')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature6')}</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-violet-600 dark:text-violet-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-neutral-600 dark:text-slate-300">{t('feature7')}</span>
                </li>
              </ul>
