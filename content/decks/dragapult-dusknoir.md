...
- Dusclops / Dusknoir should be used for a very powerful play that accomplishes something specific. Don’t pop them just because you can. If you don’t have a power play available, saving Cursed Blast is generally fine. There aren’t a lot of ways to for opponents to punish a Dusclops or Dusknoir sitting there, waiting for the right moment.
- The exception is against Psyduck. Against decks with Psyduck, you have to be very careful about evolving into Dusclops, since it can get trapped. Only evolve into Dusclops/Dusknoir if you’re sure they won’t be able to trap it, such as if you’re KO’ing Psyduck, or if you’re able to instantly use the Ability with Psyduck not currently in play. KO’ing Psyduck is sometimes a priority and sometimes not, depending on how badly you need access to Dusknoir’s Ability.
- Most of the time you’ll prioritize getting three Dreepy before the first Duskull in the early-game. The second Duskull is even less of a priority, but exceptions to all of these generalizations exist.
- Slamming Watchtower on Turn 1 is usually fine as it can make the opponent brick a decent percent of the time. You might want to save it against decks that don’t play Meowth or Kang, especially Alakazam.
...
- Consider your prize map based on your opponent’s board. This can influence whether you need to use something to set up damage in advance.
- Drakloak is a viable attacker! Don’t forget about it!
- If you start with Fezandipiti and Crispin, a fast Cruel Arrow can be good in some matchups such as mirrors.
- Don’t mindlessly slam the Unfair Stamp as soon as you can. Depending on what you’re going to be able to do, or what the opponent’s board state looks like, sometimes it is tactically better to delay the Stamp by one turn. A good example is if you’re activating their Fez now, but can KO it next turn. If the opponent’s board is not developed, it may be better to slam it now even if you can’t attack because they might brick! Is the Stamp stopping them from doing something specific? If not, maybe hold it. This is slightly less true with two Red Card in the list but it can still apply sometimes.
...
- Mind Bend is often good against Lucario, but less so if they just used Mega Brave last turn. Smacking them with Phantom Dive is also fine.
- Early Budew is very useful in this matchup to slow down their setup.
- Play around late-game Solrock by not benching Pokemon in KO range. If they don’t get a second Lucario, we don’t want to let them close out the game with Solrock.
- Try to play without Fez and Meowth. Oftentimes you have to put one down in order to play the game, which is fine, but avoid it if you can.
...
- Use Dusknoir to one-shot their Lopunny. If you can get three single-prize KO’s, that is ideal, but you an also potentially set up a second Dusknoir to KO their next Lopunny.
- If they have Psyduck, KO it as soon as you can, as you’ll eventually want to use Dusknoir.
- Watchtower, Boss, and hand disruption cards are all very useful resources in this matchup. Watchtower is generally fine to just slam whenever you have it, unless they have a big hand that you can’t disrupt.

### Garchomp - Unfavorable

- Try not to let them get any easy KO’s with Gible or Gabite within the first two turns.
- Set up Dusknoir. Ideally two, and use them as the situation demands.
- Keeping Roserade off the board is typically a good strategy since it makes it harder for them to one-shot Dragapult. Hand disruption can also be very useful against them.
