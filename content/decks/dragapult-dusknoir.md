...
Gardevoir / Jellicent - Slightly Favorable (against the build with 2-1-2 Gardevoir and no ™ EVO)
Very Unfavorable (against the ™: Evo build with 3-2-2 Gardevoir)
...
If they are playing ™: Evo, Jamming Tower can be used preemptively. Otherwise, save it to bump their Stadium when they put one in play.
...
KO’ing both of their Munkidori + using Iono can be a very strong play that limits their options. I usually prioritze KO’ing Munkidori over Froslass. Of course, Snorunt can be easily KO’d before it evolves which is sometimes more convenient.
