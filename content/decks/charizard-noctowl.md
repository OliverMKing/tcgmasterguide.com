...
- There are occasionally tempo-oriented games that do not involve Pidgeot, or sometimes the opponent is able to keep Pidgeot off the board. If you are in such a matchup or scenario, you can ignore Pidgeot and try to apply enough pressure with everyone else. In non-Pidgeot games, speed is important to close out the game as fast as possible. 
- This is a tempo-oriented deck, but with Pidgeot, it can also play a slower game like normal Charizard / Pidgeot because Charizard and Pidgeot are so versatile and bulky.
