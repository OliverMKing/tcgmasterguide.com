...
- Crispin is included because this deck is way too slow with Energy attachments and desperately needs the help. Without Crispin, it would be possible for some very good matchups to still cheese wins against Crustle by exploiting its very slow Energy situation.
...
- Hilda is rather weak most of the time but can be good for finding specific Energy types. It also improves the Alakazam matchup while also being a fairly functional card in general.
...
- Four Mist Energy is required for Alakazam and Dragapult.
...
- Explorer's Guidance could be considered over Morty.

### Exclusions

- I think the Kangaskhan is an unnecessary liability. It is too difficult to maneuver around, and giving up those prizes is a good way to instantly lose some matchups.
- Playing the non-Crispin build makes the deck unnecessarily vulnerable to random matchups (Dragapult, Mewtwo, etc.) that are able to pressure your Energy drops. It is too slow and can potentially lose to matchups that should be easy wins.
...
- The Grass Energy ensures that Dragapult cannot Hammer away all of the Growings to stop Crustle from attacking entirely. Even if you prize a Growing, there is significantly less risk against Hammer. More Energy is generally good since we want to attach Energy every turn.
...
- Sometimes single Ice Cream is irrelevant (against attackers such as Meganium or with some Kang situaions). There are lots of times where Ice Cream is either double or nothing and using a single one is a waste due to how the math works out. Think about what math Ice Cream is actually doing for you before slamming it.
...
- If you don't know if they have a Crustle counter (or if you know they don't), go with the normal Crustle gameplan. If you know they do have a counter, instead go for a fast attacking Kangaskhan and get the two Bouffalant in play. Then just play like a normal Kang Bouff deck instead. Going with Crustle is futile if you know they have a counter.
